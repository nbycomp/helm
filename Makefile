...
ifneq ($(BINARY_VERSION),)
	LDFLAGS += -X github.com/nbycomp/helm/internal/version.version=${BINARY_VERSION}
endif
...
LDFLAGS += -X github.com/nbycomp/helm/internal/version.metadata=${VERSION_METADATA}
LDFLAGS += -X github.com/nbycomp/helm/internal/version.gitCommit=${GIT_COMMIT}
LDFLAGS += -X github.com/nbycomp/helm/internal/version.gitTreeState=${GIT_DIRTY}
LDFLAGS += $(EXT_LDFLAGS)
...
LDFLAGS += -X github.com/nbycomp/helm/pkg/lint/rules.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X github.com/nbycomp/helm/pkg/lint/rules.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
LDFLAGS += -X github.com/nbycomp/helm/pkg/chartutil.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X github.com/nbycomp/helm/pkg/chartutil.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
